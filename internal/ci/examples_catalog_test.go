...
func TestReadmeDocumentsKeyExampleCatalogEntries(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"examples/alpine-secdb-sample.json",
		"examples/debian-tracker-sample.json",
		"examples/ubuntu-osv-sample.json",
		"examples/kubernetes-cve-feed-sample.json",
		"examples/vulndb-sources.yaml",
		"examples/vulndb-sources-public.yaml",
