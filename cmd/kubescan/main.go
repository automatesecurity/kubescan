...
func run(args []string) int {
	if len(args) == 0 {
		...
		fmt.Fprintln(os.Stderr, "       kubescan vm [--rootfs <dir> | --disk <path>] [--profile <name>] [--secret-scan patterns|balanced|aggressive] [--license-allow <id> ...] [--license-deny <id> ...] [--exclude-path <pattern> ...] [--sbom-out <file>] [--sbom-format cyclonedx|spdx] [(--advisories <file> | --advisories-bundle <file> --bundle-key <file>)] [--color auto|always|never] [--format table|json|html|sarif|ocsf-json] [--out <file>] [--fail-on <severity>]")
